...
export const Cards = (props) => {
  return <div className="curve curve-color">
    <svg data-name="Layer 1"  className={props.className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
